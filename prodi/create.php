...
if (isset($_POST['simpan'])) {
    ...
    if ($simpan) { 
        echo "<script>alert('✅ Berhasil menambahkan Prodi!'); window.location='index.php';</script>"; 
    } else {
        ...
        <div class="card-modern animate-entry">
            <div class="text-center mb-4">
                <div class="icon-header">
                    <iconify-icon icon="solar:buildings-bold-duotone" style="font-size: 1.8rem;"></iconify-icon>
                </div>
                <h4 class="fw-bold mb-1">Tambah Prodi</h4>
