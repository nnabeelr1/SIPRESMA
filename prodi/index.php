...
<head>
    ...
    <style>
        ...
        .badge-d3 { background: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; }
        .badge-s1 { background: #dcfce7; color: #15803d; border: 1px solid #bbf7d0; }
        .badge-s2 { background: #f3e8ff; color: #7e22ce; border: 1px solid #d8b4fe; }
    </style>
</head>
<body>
        ...
        <div class="page-header animate-entry" style="animation-delay: 0.1s;">
            ...
            <div>
                <a href="create.php" class="btn-gradient-primary">
                    <iconify-icon icon="solar:add-circle-bold" class="fs-5"></iconify-icon> Tambah Prodi
                </a>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <span class="fw-bold text-dark font-monospace"><?php echo $data['kode_prodi']; ?></span>
                                </td>
                                
                                <td>
                                    <span class="fw-bold text-dark"><?php echo $data['nama_prodi']; ?></span>
                                </td>
                                ...
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="update.php?id=<?php echo $data['id_prodi']; ?>" class="btn-action-soft btn-soft-warning" title="Edit">
                                            <iconify-icon icon="solar:pen-bold" class="fs-5"></iconify-icon>
                                        </a>
                                        <a href="delete.php?id=<?php echo $data['id_prodi']; ?>" class="btn-action-soft btn-soft-danger" onclick="return confirm('Hapus prodi ini?')" title="Hapus">
