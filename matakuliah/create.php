...
if (isset($_POST['simpan'])) {
    ...
    $simpan = mysqli_query($koneksi, "INSERT INTO matakuliah (kode_mk, id_prodi, nama_mk, sks, semester_paket) VALUES ('$kode', '$prodi', '$nama', '$sks', '$smt')");

    if ($simpan) { 
        echo "<script>alert('✅ Berhasil menambahkan MK!'); window.location='index.php';</script>"; 
    } else {
...
<head>
    ...
    <title>Tambah Matkul - SIPRESMA</title>
        ...
        <div class="card-modern animate-entry">
            <div class="text-center mb-4">
                <div class="icon-header">
                    <iconify-icon icon="solar:notebook-bold-duotone" style="font-size: 1.8rem;"></iconify-icon>
                </div>
                <h4 class="fw-bold mb-1">Tambah Mata Kuliah</h4>
                <p class="text-muted small">Input data kurikulum baru.</p>
            </div>
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" name="nama_mk" class="form-control" placeholder="Cth: Algoritma" required>
                    </div>
                </div>
