        ...
        <div class="page-header animate-entry" style="animation-delay: 0.1s;">
            ...
            <div>
                <a href="create.php" class="btn-gradient-primary">
                    <iconify-icon icon="solar:add-circle-bold" class="fs-5"></iconify-icon> Buka Kelas
                </a>
            </div>
        </div>
                        ...
                        if(mysqli_num_rows($query) == 0) {
                            echo "<tr><td colspan='6'>
                                <div class='empty-state'>
                                    <iconify-icon icon='solar:black-hole-linear' class='empty-icon'></iconify-icon>
                                    <h6 class='fw-bold text-dark'>Belum Ada Kelas Dibuka</h6>
                                    <p class='text-muted small'>Silakan buka kelas baru untuk semester ini.</p>
                                </div>
                            </td></tr>";
                        }
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="small text-muted fw-bold"><?php echo $data['nama_lengkap']; ?></span>
                                    </div>
                                </td>
                                
                                <td class="text-center">
                                    <span class="badge-pill badge-kelas"><?php echo $data['nama_kelas']; ?></span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <span class="text-muted small">
                                        ...
                                        <?php echo date('H:i', strtotime($data['jam_mulai'])) . ' - ' . date('H:i', strtotime($data['jam_selesai'])); ?>
                                    </span>
                                </td>
                                
                                <td class="text-end">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a href="update.php?id=<?php echo $data['id_kelas']; ?>" class="btn-action-soft btn-soft-warning" title="Edit">
                                            <iconify-icon icon="solar:pen-bold" class="fs-5"></iconify-icon>
                                        </a>
                                        <a href="delete.php?id=<?php echo $data['id_kelas']; ?>" class="btn-action-soft btn-soft-danger" onclick="return confirm('Hapus kelas ini?')" title="Hapus">
