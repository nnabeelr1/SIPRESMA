...
<head>
    ...
    <style>
        ...
        .alert-glass {
            ...
            color: #1e40af; padding: 0.8rem; border-radius: 12px;
            font-size: 0.85rem; display: flex; gap: 8px; align-items: center; margin-bottom: 1.5rem;
        }
    ...
    <div class="container mb-5">
        <div class="card-modern animate-entry">
            <div class="text-center mb-4">
                ...
                <h4 class="fw-bold mb-1">Edit Data Dosen</h4>
                <p class="text-muted small">Perbarui informasi dosen pengajar.</p>
            </div>
            ...
            <form method="POST">
                ...
                <div class="alert-glass">
                    ...
                    <div>Username: <strong><?php echo $data['username']; ?></strong> (Terkunci)</div>
                </div>

                <div class="mb-3">
                    <label class="form-label">NIDN</label>
                    <input type="text" name="nidn" class="form-control" value="<?php echo $data['nidn']; ?>" readonly style="background-color: #f1f5f9; cursor: not-allowed;">
                </div>
