...
if (isset($_POST['simpan'])) {
    ...
    if ($insert_user) {
        ...
        if ($insert_dosen) {
            echo "<script>alert('✅ Berhasil! Akun & Data Dosen tersimpan.'); window.location='index.php';</script>";
        } else {
            echo "<script>alert('❌ Gagal Simpan Dosen: " . mysqli_error($koneksi) . "');</script>";
        }
    } else {
        echo "<script>alert('❌ Gagal Simpan User: " . mysqli_error($koneksi) . "');</script>";
    }
}
...
<head>
    ...
    <style>
        ...
        .card-modern {
            ...
            max-width: 600px; /* Lebih lebar dikit karena 2 kolom */
            margin: 2rem auto;
    ...
    <div class="container mb-5">
        <div class="card-modern animate-entry">
            <div class="text-center mb-4">
                ...
                <p class="text-muted small">Buat akun login dan data dosen baru.</p>
            </div>
            ...
            <form method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="cth: dosen1" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="form-section-title"><iconify-icon icon="solar:user-id-bold"></iconify-icon> 2. Biodata Dosen</div>
                <div class="mb-3">
                    <label class="form-label">NIDN (Nomor Induk)</label>
                    <input type="text" name="nidn" class="form-control" placeholder="Nomor Induk Dosen Nasional" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Nama Lengkap (+Gelar)</label>
                    <input type="text" name="nama_lengkap" class="form-control" placeholder="Cth: Dr. Budi Santoso, M.Kom" required>
                </div>
                <div class="mb-3">
